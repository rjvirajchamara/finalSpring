...
export class MyService {
    ...
    public uploadFile(myFile: File):Observable<boolean>{
        ...
        console.log("11 : "+myFile);
        let myFormData = new FormData();
        console.log("22 :"+myFormData);
        // Then we are going to append the file into the FormData object
        myFormData.append("myFile",myFile,myFile.name);
        console.log("33 :"+myFormData);
        console.log("44 myFile.name :"+myFile.name);
    ...
    //             }
    //         }
    //        // this.baseuri+'/api/v1/items/'+item.code,item);
    //         xhr.open("POST", this.baseUrl + '/api/v1/employee', true);
    //         xhr.send(formData)
    //     }));
    // }
